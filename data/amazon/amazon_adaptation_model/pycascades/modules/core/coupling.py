...
class linear_coupling(coupling):
    ...
    def dxdt_cpl(self):
        """Returns callable for the coupling term of dxdt."""
        return lambda t, x_from , x_to : self._strength * (x_from - self._x_0) if x_from < 1.0 else self._strength * (1.0 - self._x_0) # if statement limits coupling to max coupling
